            ...
            .then(response => {
                ...
                if(startPage > 1) {
                    ...
                    pagination.innerHTML = `<li class="page-item">
                                                <a class="page-link" style="background-color: #27587E; border-color: #27587E; margin-right: 2px" href="#" data-page="${startPage - 1}">이전</a>
                                             </li>`;
                }

                for (let i = startPage; i <= endPage; i++) {
                    const pageElement = `<li class="page-item ${i === currentPage ? 'active' : ''}">
                                                    <a class="page-link" style="background-color: #27587E; border-color: #27587E; margin-right: 2px;" href="#" data-page="${i}">${i}</a>
                                                 </li>`;
                ...
                if (endPage < totalPage) {
                    pagination.innerHTML += `<li class="page-item">
                                                <a class="page-link" style="background-color: #27587E; border-color: #27587E; margin-right: 2px"  href="#" data-page="${endPage + 1}">다음</a>
                                             </li>`;
                }
